...
<body>
    ...
    <form method='post' action='newSales.php'>
        <table width='500' border='3' align='center'>
            <tr>
                <th bgcolor='gray' colspan='5'>Sales Registration Form</th>
            </tr>
            <tr>
                ...
                while ($product = mysqli_fetch_row($result2)):
                    ?>
                            <option value="<?php echo $product[0] ?>">
                                <?php echo "Name --> ".$product[1]  ." | Price --> ".$product[2] ." | Quantity --> ".$product[3]?>
                            </option>
                            <?php endwhile; ?>
                    </select>
                </td>
...
<?php 
    ...
    if(isset($_POST['submit']))
    {
    	...
    	if($product_quantity < $quantity){
    		...
    		if($query){
    				echo "<center><b>New sale successfully registered.</b></center><br>";
    				echo 
